...
# 12.02.2026   | Kumaran Sekar          | Commented line of code is removed in few parts.
#################################################################################################################
...
def check_artifacts():
    ...
    if "not" in _PD_filename:
        ...
        if (os.path.exists(_pd_ver_file)):
            ...
            print("The file doesn't exists, Hence it will be downloaded. \n")
...
def download_from_sharepoint(_url, _filename):
    ...
    _file_url = _url
    print("\nstarting the download for file:",_file_url ) 
